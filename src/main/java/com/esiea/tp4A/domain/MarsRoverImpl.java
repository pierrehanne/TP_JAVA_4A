...
public class MarsRoverImpl implements MarsRover {
    ...
    public Position move (String command){
        boolean obstacle = this.obstacleDetection(command, planetMap);
    ...
    public Position initPosNextToObstacle(String obstaclePosition){
    ...
    public boolean obstacleDetection(String command, PlanetMapImpl planetMap) {
